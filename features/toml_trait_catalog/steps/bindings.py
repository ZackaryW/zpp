...
register_exact_steps(
    (
        ...
        "a trait document omits activation metadata",
        "the family activation is automatic",
        "a trait document declares manual activation",
        "the family activation is manual",
        "a trait document declares an unsupported activation mode",
        "the failure identifies meta activation",
        ...
        "the repository document supplies the effective selection and activation "
        "policies",
