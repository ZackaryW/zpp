...
register_exact_steps(
    (
        ...
        "a user inspects the confirmed reset target catalog",
        "every discovered companion skill is targeted for each supported agent",
        "those targets follow hook workflow skill then deterministic companion order",
        "no declared list of companion skill names determines that catalog",
