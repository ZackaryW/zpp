...
description: Translate a fully confirmed OpenSpec proposal and its capability delta specs into the complete Gherkin feature and fix set without step definitions, product wiring, or invented policy, then prepare the change-wide feature-contract checkpoint. Use only after the complete product boundary has converged.
---
...
- Translate accepted public behavior from the proposal and declared capability deltas; never use BDD to complete or redesign the product contract.
