...
targets for planning. On `blocked`, pause. On `completed`, obtain the kernel result
assessment when consuming clarification as a lifecycle gate and continue.

## Reconcile the change plan
...
## Shape the regression authority
...
never skips maturation or authorizes wiring. A plan
...
## Mature the correction utilities
