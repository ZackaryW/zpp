...
repository test context. For a plan, also require selected RED observations and a
current kernel assessment for every exact root and change target. The kernel invokes ZPP runtime
